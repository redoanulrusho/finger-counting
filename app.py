...
# Webcam capture (use 0 for default camera)
...
while True:
    ...
    count_placeholder.markdown(f"### {finger_count_text}")

    # Exit Streamlit app if user closes it (no explicit ESC handling here)
